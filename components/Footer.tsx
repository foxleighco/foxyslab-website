    ...
    <footer className="bg-secondary/50 border-t border-primary/20 mt-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Brand */}
          <div>
            <h3 className="text-xl font-bold gradient-text mb-4">Foxy&apos;s Lab</h3>
        ...
        <div className="mt-8 pt-8 border-t border-primary/20 text-center text-white/40 text-sm">
          <p>&copy; {currentYear} Foxy&apos;s Lab. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
